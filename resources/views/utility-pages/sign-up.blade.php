<!DOCTYPE html>
<html data-wf-page="66cc87062bcd9d178ab9f2ad" data-wf-site="66cc87062bcd9d178ab9f11c" lang="de">
<head>
  <meta charset="utf-8">
  <title>Sign Up - Crealo CMS Pro</title>
  ...
  <meta content="Utility Pages - Sign Up - Dashly X - Webflow Ecommerce website template" property="og:title">
  ...
  <meta content="Utility Pages - Sign Up - Dashly X - Webflow Ecommerce website template" property="twitter:title">
...
<body>
  <div data-w-id="218b7c68-e948-d829-59b4-d2f7b3a9b2f9" style="opacity:0" class="page-wrapper">
    <div class="sign-up-page-main-container">
      <div class="sign-up-page-left-side">
        <div class="sign-up-page-logo-container">
          <div class="inner-container _434px width-100">
            <a href="{{ route('index') }}" class="sign-up-page-logo w-inline-block"><img src="{{ asset('images/dashly-webflow-template-logo.svg') }}" loading="eager" alt="Dashly X Webflow Template - Logo"></a>
          </div>
        </div>
        <div class="inner-container _434px width-100 _100-mbl">
          ...
          <div class="flex align-center mg-bottom-32px">
            <div class="mg-bottom-0 mg-right-8px w-form">
              <form id="email-form" name="email-form" data-name="Email Form" method="get" data-wf-page-id="66cc87062bcd9d178ab9f2ad" data-wf-element-id="6d9128ea-d1c5-855b-2271-33af98f5214f"><label class="w-checkbox checkbox-field-wrapper small">
            ...
            <div class="text-200 medium color-neutral-700">Accept terms and conditions</div>
          </div>
      ...
      <div class="sign-up-page-right-side">
        <div class="inner-container _478px width-100"><img src="{{ asset('images/sign-up-illustration-dashboardly-webflow-template.svg') }}" loading="eager" alt="Sign Up - Dashly X Webflow Template" class="width-100"></div>
        <div class="sign-up-page-right-side-bg"></div>
      </div>
    </div>
