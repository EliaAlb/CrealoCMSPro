<!DOCTYPE html>
<html data-wf-page="66cc87062bcd9d178ab9f2aa" data-wf-site="66cc87062bcd9d178ab9f11c" lang="de">
<head>
  <meta charset="utf-8">
  <title>Reset Password - Crealo CMS Pro</title>
  ...
  <meta content="Utility Pages - Reset Password - Dashly X - Webflow Ecommerce website template" property="og:title">
  ...
  <meta content="Utility Pages - Reset Password - Dashly X - Webflow Ecommerce website template" property="twitter:title">
...
<body>
  <div data-w-id="026df77e-568b-0b14-b87b-a75d5bf563df" style="opacity:0" class="page-wrapper">
    ...
    <div class="dashboard-main-content utility-page">
      <div class="container-default w-container">
        <div data-w-id="addb6871-5277-6402-4323-a4c04e5c1ee2" style="opacity:0" class="module utility-page-form">
          <div class="inner-container _444px text-center">
            <div class="inner-container _80px-mbl center"><img src="{{ asset('images/password-icon-dashboardly-webflow-template.svg') }}" loading="eager" alt="" class="mg-bottom-20px"></div>
