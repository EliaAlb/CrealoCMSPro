...
<html data-wf-page="66cc87062bcd9d178ab9f277" data-wf-site="66cc87062bcd9d178ab9f11c" lang="de">
<head>
  <meta charset="utf-8">
  <title>Utility Pages - Email Confirmation - Dashly X - Webflow Ecommerce website template</title>
  ...
  <meta content="Utility Pages - Email Confirmation - Dashly X - Webflow Ecommerce website template" property="og:title">
  ...
  <meta content="Utility Pages - Email Confirmation - Dashly X - Webflow Ecommerce website template" property="twitter:title">
...
<body>
  <div data-w-id="cda33b02-c2f5-b8cd-3ae3-b6776017f117" style="opacity:0" class="page-wrapper">
    <div data-w-id="27d30c7f-b701-adb6-622d-3e7968cd8f44" class="top-bar-simple">
      <div class="container-default w-container">
        <div class="flex-horizontal">
          <a href="../index.html" class="top-bar-simple-logo w-inline-block"><img src="../images/dashly-webflow-template-logo.svg" loading="eager" alt="Dashly X Webflow Template - Logo"></a>
        </div>
      </div>
    </div>
    <div class="dashboard-main-content utility-page">
      <div class="container-default w-container">
        <div data-w-id="cda33b02-c2f5-b8cd-3ae3-b6776017f11b" style="opacity:0" class="module utility-page-form">
          <div class="inner-container _444px text-center">
            <div class="inner-container _80px-mbl center"><img src="../images/email-confirmation-icon-dashboardly-webflow-template.svg" loading="eager" alt="" class="mg-bottom-20px"></div>
            <div class="heading-h3-size mg-bottom-8px">Please confirm your email</div>
            ...
            <div class="form min-h-116px w-form">
              <form id="email-form" name="email-form" data-name="Email Form" method="get" data-wf-page-id="66cc87062bcd9d178ab9f277" data-wf-element-id="cda33b02-c2f5-b8cd-3ae3-b6776017f124"><input class="input mg-bottom-12px w-input" maxlength="256" name="email-2" data-name="Email 2" placeholder="Email address" type="email" id="email-2" required=""><input type="submit" data-wait="Please wait..." class="btn-primary width-100 w-button" value="Reset password"></form>
              <div class="success-message utility-page-success-message w-form-done">
                <div>The confirmation link has been sent to your email</div>
              </div>
